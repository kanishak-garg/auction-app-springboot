...
public class ProductDto {
    ...
    @NotNull
	@Size(min = 3,max = 100, message = "name should have at least 3 characters and atmost 100 characters")
	private String name;
	
	private Long sellerId;
    
    @NotNull
	@Size(min = 3,max = 100, message = "description should have at least 3 characters and atmost 100 characters")
    ...
    @NotNull
	@Size(min = 3,max = 100, message = "category should have at least 3 characters and atmost 100 characters")
